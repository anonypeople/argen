...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:redirect="org.apache.xalan.lib.Redirect"
                    ...
                    <xsl:for-each select="./Packages/Package">
                        <xsl:if test="count(error) = 0">
                            <tr>
                                <td align="left">
                                    <a>
                                        <xsl:attribute name="href">overview-packages.html#PK<xsl:value-of
                                                select="@name"/>
                                        </xsl:attribute>
        ...
        <html>
            ...
            <body>
                ...
                <xsl:for-each select="Cycles/Package">
                    <h3>
                        <a>
                            <xsl:attribute name="name">#CY<xsl:value-of select="@Name"/>
                            </xsl:attribute>
                            <xsl:value-of select="@Name"/>
                        </a>
                    </h3>
    ...
    <xsl:template name="pageHeader">
        ...
        <table width="100%">
            <tr>
                <td align="left"></td>
                <td align="right">Designed for use with <a href="http://www.clarkware.com/software/JDepend.html">
                    JDepend
