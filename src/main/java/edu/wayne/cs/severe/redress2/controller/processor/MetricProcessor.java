...
public class MetricProcessor {
     ...
     * @param lang       the programming language in which the system is implemented
     * @param parseSrcML
     */
     ...
     * @throws WritingException    if the file could not be saved
     * @throws CompilUnitException if there is an error parsing the code
     * @throws IOException
     */
