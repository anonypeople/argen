...
public class LCOM2PullUpMethodPF extends PullUpMethodPredFormula {
    ...
    public HashMap<String, Double> predictMetrVal(RefactoringOperation ref,
        ...
        for (TypeDeclaration srcCls : srcClses) {
            predMetrs.put(srcCls.getQualifiedName(),
                    getValLCOM(srcCls, method, -1, deltaFieldsUsed, 0, false));
        }
        ...
        predMetrs.put(
                ...
                getValLCOM(tgtCls, method, 1, deltaFieldsUsedTgt,
    ...
    private Double getValLCOM(TypeDeclaration typeDcl,
        ...
        double metric = (numMethods == 0 || numFields == 0) ? 0
                : 1 - ((numFieldUsage + mult * numAttrMethod + (isTgt ? 0.0
                : deltaFieldsUsed)) / (numMethods * numFields));
        return metric;
    }
