...
public class JavaCompilUnitParser extends CompilUnitParser {
     ...
     *
     * @param typeDcl the type declaration
     */
     ...
     *
     * @param xpExpr          the xpath expression to find the types
     * @param compUnit        the compilation unit
     * @param classNoGenerics true if no generics, false otherwise
