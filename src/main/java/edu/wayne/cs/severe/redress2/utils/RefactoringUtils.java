...
public class RefactoringUtils {
    ...
    /**
     * @param cumulativePredMetrics the cumulative metric values
     * @param predictMetrVal        the predicted metrics
     * @param allClasses            the map that contains all the classes involved in the
     *                              refactoring
